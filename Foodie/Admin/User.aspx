<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/OnlineFoodMaster.Master" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="Foodie.Admin.User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="table-box">
        <h2 class="table-title">User Registerd</h2>
        
        <asp:GridView ID="GridView3" runat="server" Height="128px" AutoGenerateColumns="False" OnRowCommand="GridView3_RowCommand" style="margin-left: 18px" Width="595px">
             <Columns>
